...
class LiDARClassifier:
    """
    Thin inference wrapper around a trained PointNetClassifier.
    Clusters an incoming point cloud (numpy N×3) into segments and
    returns per-segment (class_name, confidence, centroid) triples.
    """
